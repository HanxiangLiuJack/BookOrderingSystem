...
public class BookPersistenceStub implements BookPersistence {
    ...
    public BookPersistenceStub()
    {
        ...
        books.add(new Book("One Way","S. J. Morden",9,"Frank Kittridge is serving life for murdering his son's drug dealer, so when he's offered a deal by Xenosystems Operations - the corporation that owns the prison - he takes it. He's been selected to help build the first permanent base on Mars. Unfortunately, his crewmates are just as guilty of their crimes as he is. ","moive",33.22,2));
