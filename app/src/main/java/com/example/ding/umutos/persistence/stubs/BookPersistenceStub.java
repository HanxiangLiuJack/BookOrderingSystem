...
public class BookPersistenceStub implements BookPersistence {
    ...
    public BookPersistenceStub()
    {
        ...
        books.add(new Book("Agile Development", "James Shore",1,"The Art of Agile Development contains practical guidance for anyone considering or applying agile development for building valuable software. Plenty of books describe what agile development is or why it helps software projects succeed, but very few combine information for developers, managers, testers, and customers into a single package that they can apply directly.","Journalism, media studies and communication",33.86,1));
